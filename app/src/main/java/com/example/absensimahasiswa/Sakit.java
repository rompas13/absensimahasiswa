...
public class Sakit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvMatakuliah = findViewById(R.id.edit_text_mata_kuliah);
        ...
        btnKirim = findViewById(R.id.button_sakit);
        ...
        btnUpload.setOnClickListener(v -> {
            ...
            fileLauncher.launch(Intent.createChooser(intent, "Pilih bukti sakit"));
        });
    ...
    private void kirimDataDenganFoto(String nim, String nama, String tanggal, String alasan, String matkul, Uri uri) {
        String url = "http://192.168.28.22/andro/input_sakit.php";

        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, url,
                response -> {
                    Toast.makeText(Sakit.this, "Pengajuan sakit berhasil dikirim!", Toast.LENGTH_SHORT).show();
                    finish();
                },
                error -> {
                    String msg = (error.getMessage() != null) ? error.getMessage() : "Gagal mengirim data!";
                    Toast.makeText(Sakit.this, msg, Toast.LENGTH_LONG).show();
                }
        ) {
            @Override
